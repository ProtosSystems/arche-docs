    ...
    typography: ({ theme }) => ({
      DEFAULT: {
        css: {
          ...
          '--tw-prose-links': 'var(--docs-link)',
          '--tw-prose-links-hover': 'var(--docs-link-hover)',
          '--tw-prose-links-underline': 'var(--docs-link-underline)',
          ...
          '--tw-prose-invert-links': 'var(--docs-link)',
          '--tw-prose-invert-links-hover': 'var(--docs-link-hover)',
          '--tw-prose-invert-links-underline': 'var(--docs-link-underline)',
          ...
          a: {
            ...
            '&:hover': {
              ...
              textDecorationColor: 'var(--docs-link-underline-hover)',
            },
          },
          ':is(h1, h2, h3) a': {
            fontWeight: 'inherit',
