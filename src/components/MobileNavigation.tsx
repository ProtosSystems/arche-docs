...
function MobileNavigationDialog({
  ...
  return (
    ...
    >
      <DialogBackdrop
        transition
        className="fixed inset-0 top-14 bg-black/20 backdrop-blur-xs data-closed:opacity-0 data-enter:duration-300 data-enter:ease-out data-leave:duration-200 data-leave:ease-in"
      />
      ...
      <DialogPanel>
        ...
        <TransitionChild>
          <motion.div
            layoutScroll
            className="fixed top-14 bottom-0 left-0 w-full overflow-y-auto bg-[color:var(--docs-bg)] px-4 pt-6 pb-4 shadow-lg ring-1 shadow-black/5 ring-[color:var(--docs-border)] duration-500 ease-in-out data-closed:-translate-x-full min-[416px]:max-w-sm sm:px-6 sm:pb-10"
          >
            <Navigation />
          </motion.div>
        </TransitionChild>
  ...
  return (
    <IsInsideMobileNavigationContext.Provider value={true}>
      ...
      >
        ...
        <ToggleIcon className="w-2.5 stroke-[color:var(--docs-text)]" />
      </button>
